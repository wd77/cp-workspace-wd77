...
cprequire_test(["inline:de-wd77-cp-workspace-wd77"], function(ws) {
    ...
    $('title').html("WD77 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:de-wd77-cp-workspace-wd77", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "de-wd77-cp-workspace-wd77", // Make the id the same as the cpdefine id
        name: "WD77 Workspace", // The descriptive name of your widget.
        desc: `The  WD77 lean Workspace, optimized for smaller screens.`,
